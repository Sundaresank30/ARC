    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/data-preparation/**").hasAnyRole("MANAGER", "OPERATOR")
                        .requestMatchers("/api/source-documents/**").hasAnyRole("MANAGER", "OPERATOR")
                        .requestMatchers("/api/machine/**").hasRole("OPERATOR")
                        .requestMatchers("/api/embossing/**").hasRole("OPERATOR")
                        .requestMatchers("/api/leakage-testing/**").hasRole("OPERATOR")
