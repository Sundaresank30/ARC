...
import com.arc.login.security.CustomUserDetailsService;
import com.arc.login.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/data-preparation/**", "/api/dashboard/**").hasRole("MANAGER")
                        .requestMatchers("/api/data-embossing/**", "/api/leakage-testing/**").hasRole("OPERATOR")
